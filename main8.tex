...
Thus, BTestBox is being developed as a solution to test the translated code and to assure that the translation is performed well. Additionally, it may help the verification process to find counterexamples.
...
%\marginpar{Um grande diferencial do BTestBox em relação as outras ferramentas está na capacidade de gerar testes para cinco diferentes critérios de cobertura. Isso amplia as configurações de testes e pode ser melhor explorado no texto.}
