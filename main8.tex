...
BTestBox supports several code coverage criteria and code
...
The present version of BTestBox uses parallelisation techniques that
...
BTestBox tests the translated code and assures dependability of the translation. 
Additionally, BTestBox may help the verification process to find counterexamples.
